...
<html lang="en">
    ...
    <head>
        ...
        <title>View Vehicles List</title>
                                        ...
                                        <tr class="row">
                                            ...
                                            <td class="col-sm-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <img src="${vehicle.image_url}" alt="${vehicle.image_url}" class="rounded"  width="50" height="50"> 
                                            ...
                                            <td class="col-sm-1">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                                        ...
                                                        <li><a href="arch_vehicleProcess?id=${vehicle.vehicleId}" style="color: black; margin: 10px;">Archive Vehicle</a></li>
                                                        <li><a href="delete_vehicleProcess?id=${vehicle.vehicleId}" style="color: black; margin: 10px;">Delete Vehicle</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
