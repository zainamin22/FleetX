                                        ...
                                        <tr class="row">
                                            ...
                                            <td class="col-sm-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <img src="${driver.image}" class="rounded-circle"  width="40" height="40"> 

                                                    </div>
                                                    <div class="col-sm-6">

                                                        <p class="text-left">${driver.firstName} ${driver.lastName}</p>
                                            ...
                                            <td class="col-sm-2">${driver.city}</td>
                                            <td class="col-sm-1 text-center"><span class="badge badge-secondary">${driver.countOfVehicles}</span></td>
                                            ...
                                            <td class="col-sm-1">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                                        <li><a href="view_driver_details?id=${driver.driverId}" style="color: black; margin: 10px;">View Driver Profile</a></li>
                                                         <li><a href="view_driver_trips?id=${driver.driverId}" style="color: black; margin: 10px;">View Trip Reports</a></li>
