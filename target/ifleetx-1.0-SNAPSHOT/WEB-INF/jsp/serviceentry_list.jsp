            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Service Entry List</li>
                    </ol>
                    ...
                    <div class="row">
                        ...
                        <c:forEach items="${serviceentry}" var="ins">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="cap"> <span style=" background-color: ${ins.statusColor} ;" class="dot"></span>  ${ins.wtitle}</h4>
                                        ...
                                        <p>&nbsp;</p>
                                        <span class="til">Service Task Status</span>
                                            <span class="badge badge-secondary float-right m-2 ">${ins.serviceTaskStatus}</span>   
                                      
                                        <hr/>
                                        
                                        
                                            <span class="til">Entry Status</span>
