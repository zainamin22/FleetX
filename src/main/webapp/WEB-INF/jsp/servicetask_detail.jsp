...
<html lang="en">
    ...
    <head>
        ...
        <title>Service Task Details</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row qwe  text-white card" >
                        <div class="col-md-6" style="margin: 15px 10px 0px 10px;">
                            ...
                            <span class="cap">${workorder.wstatus}</span><span> (</span><span>${workorder.checked_servicetask}</span><span> of </span><span>${workorder.total_servicetask}</span><span>)</span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card bg-info text-white">
                                <div class="card-body">Service Task list</div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <span class="bod badge ${part.color} text-white cap" style="margin-bottom: 10px; margin-left: 10px; font-size: 16px;">${part.status}</span>
