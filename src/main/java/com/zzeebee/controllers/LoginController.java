...
public class LoginController {
    ...
    public ModelAndView showLogin(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (request.getSession().getAttribute("admin_id") != null) {
            ...
            ModelAndView mav = getModel(request,admin);
            return mav;
        }
    ...
    public ModelAndView getModel(HttpServletRequest request,Admin admin) {
        ...
        request.getSession().setAttribute("name", admin.getFirstName() + " " + admin.getLastName());
        request.getSession().setAttribute("pimage", admin.getImage());
